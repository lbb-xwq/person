...
export const hero = {
  ...
  ariaLabel: '前端开发工程师',
  infoTag: '[ 信息日志 ]',
  infoLines: ['九年时间把界面做稳：中后台系统、数据可视化、', '组件体系与工程化，从 0 到 1 能独立落地。'],
  mobileStats: [
    { value: '9 年', label: '年限' },
    { value: '12+', label: '技术栈' },
  ],
...
export const about = {
  ...
  lede: '九年里一直在做企业级前端：中后台系统、数据可视化大屏、组件体系与工程化建设。习惯从 0 到 1 搭架构，也习惯回头把老项目的构建和性能问题一个个收拾干净。',
  /** 40 帧图序列（程序化生成，无外部素材） */
  ...
  sectors: [
    ...
    },
    {
      ...
      name: '工作经历',
      zh: '工作经历',
      body: '九年前端开发工作经验，从页面与交互实现，到系统架构、组件体系与工程化建设，职责逐步扩展到独立负责子系统。',
      tags: [
